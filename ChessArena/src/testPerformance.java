    ...
    public static void performanceOpt(long BP,long BN,long BB,long BR,long BQ,long BK,long NP,long NN,long NB,long NR,long NQ,long NK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ,boolean WhiteToMove,int depth)
    {
        ...
        for (int i=0;i<moves.length();i+=4) {
            ...
            if (((BKt&MouvementKing.danger_B(BPt,BNt,BBt,BRt,BQt,BKt,NPt,NNt,NBt,NRt,NQt,NKt))==0 && WhiteToMove) ||
                ...
                perft(BPt,BNt,BBt,BRt,BQt,BKt,NPt,NNt,NBt,NRt,NQt,NKt,EPt,CWKt,CWQt,CBKt,CBQt,!WhiteToMove,depth+1);
                System.out.println(moveToAlgebra(moves.substring(i,i+4))+" "+cptMove);
                cptPerformanceMove+=cptMove;
                cptMove=0;
            }
        }
    }
